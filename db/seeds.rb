...
event1 = Event.create(user_id: user1, name: "The Dark Forest Mystery",
                      ...
                      category: "Adventure", theme: "Fantasy", address: "Edwinstowe, Mansfield NG21 9QB, Royaume-Uni", price: 35, participants_min: 15, participants_max: 50, date_sub: '2024-09-10', date_event: '2024-09-15', status: "Open", latitude: 55.9533, longitude: -3.1883)

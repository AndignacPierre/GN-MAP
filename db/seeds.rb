...
user1 = User.create!(username: "LarpMaster", first_name: "Liam", last_name: "Harrison", email: "liam.harrison@larpworld.com", level: 850)
user2 = User.create(username: "DragonSlayer", first_name: "Sophia", last_name: "Martin", email: "sophia.martin@gnhub.com", level: 920)
user3 = User.create(username: "ElvenArcher", first_name: "Ethan", last_name: "Carter", email: "ethan.carter@roleplay.com", level: 780)
user4 = User.create(username: "CyberMage", first_name: "Isabella", last_name: "Lewis", email: "isabella.lewis@cyberrealm.org", level: 900)
user5 = User.create(username: "StealthNinja", first_name: "Ava", last_name: "Roberts", email: "ava.roberts@shadowclan.net", level: 910)
user6 = User.create(username: "WitchHunter", first_name: "James", last_name: "Anderson", email: "james.anderson@gnadventure.com", level: 870)
user7 = User.create(username: "DragonKnight", first_name: "Nathan", last_name: "Simmons", email: "nathan.simmons@dragonorder.com", level: 870)
user8 = User.create(username: "CosmicSorcerer", first_name: "Ella", last_name: "Green", email: "ella.green@cosmicmagic.net", level: 920)
user9 = User.create(username: "BattleBard", first_name: "Henry", last_name: "Wright", email: "henry.wright@bardstale.com", level: 550)
user10 = User.create(username: "VampireSlayer", first_name: "Madison", last_name: "Gray", email: "madison.gray@vampirehunter.com", level: 890)
user11 = User.create(username: "PaladinProtector", first_name: "Mason", last_name: "Davis", email: "mason.davis@holyorder.com", level: 850)
user12 = User.create(username: "DwarfEngineer", first_name: "Mia", last_name: "Scott", email: "mia.scott@steampunkforge.com", level: 620)
user13 = User.create(username: "NecroLord", first_name: "Benjamin", last_name: "Baker", email: "benjamin.baker@darkrealm.org", level: 780)
user14 = User.create(username: "RangerScout", first_name: "Charlotte", last_name: "Wilson", email: "charlotte.wilson@forestfables.com", level: 490)
user15 = User.create(username: "MechPilot", first_name: "Elijah", last_name: "Moore", email: "elijah.moore@mechuniverse.com", level: 700)
user16 = User.create(username: "ShadowAssassin", first_name: "Harper", last_name: "Taylor", email: "harper.taylor@assassinsguild.com", level: 930)
user17 = User.create(username: "VikingWarrior", first_name: "Alexander", last_name: "White", email: "alexander.white@vikingrpg.com", level: 760)
user18 = User.create(username: "SpellCaster", first_name: "Amelia", last_name: "Harris", email: "amelia.harris@wizardingworld.com", level: 830)
user19 = User.create(username: "SamuraiSword", first_name: "Logan", last_name: "Young", email: "logan.young@feudaljapan.org", level: 690)
user20 = User.create(username: "SpaceMarine", first_name: "Abigail", last_name: "Clark", email: "abigail.clark@scifirealm.com", level: 850)
user21 = User.create(username: "PhoenixMage", first_name: "Jack", last_name: "Evans", email: "jack.evans@phoenixorder.com", level: 810)
user22 = User.create(username: "CosmicSorcerer", first_name: "Ella", last_name: "Green", email: "ella.green@cosmicmagic.net", level: 920)
user23 = User.create(username: "BattleBard", first_name: "Henry", last_name: "Wright", email: "henry.wright@bardstale.com", level: 550)
user24 = User.create(username: "SteampunkAlchemist", first_name: "Grace", last_name: "Mitchell", email: "grace.mitchell@steampunkalchemy.org", level: 630)
user25 = User.create(username: "GalacticRanger", first_name: "Samuel", last_name: "Perez", email: "samuel.perez@galacticquest.com", level: 780)
user26 = User.create(username: "ArcaneScholar", first_name: "Lily", last_name: "Rivera", email: "lily.rivera@arcanemystic.com", level: 880)
user27 = User.create(username: "DarkElfAssassin", first_name: "Daniel", last_name: "Hughes", email: "daniel.hughes@darkelves.com", level: 750)
user28 = User.create(username: "StarshipCaptain", first_name: "Chloe", last_name: "Reed", email: "chloe.reed@starfleetcommand.net", level: 940)
user29 = User.create(username: "WastelandNomad", first_name: "Michael", last_name: "Long", email: "michael.long@wastelandsurvivor.com", level: 670)
user30 = User.create(username: "DemonHunter", first_name: "Zoe", last_name: "Ross", email: "zoe.ross@hellgate.org", level: 860)
user31 = User.create(username: "SamuraiRonin", first_name: "David", last_name: "Foster", email: "david.foster@roninwarrior.com", level: 720)
user32 = User.create(username: "MoonlightSorceress", first_name: "Emily", last_name: "Morgan", email: "emily.morgan@moonlightspell.com", level: 910)
user33 = User.create(username: "TechnoWizard", first_name: "Joshua", last_name: "Collins", email: "joshua.collins@techrealm.net", level: 800)
user34 = User.create(username: "VampireSlayer", first_name: "Madison", last_name: "Gray", email: "madison.gray@vampirehunter.com", level: 890)
user35 = User.create(username: "CyberSamurai", first_name: "Jacob", last_name: "Brooks", email: "jacob.brooks@cybersamurai.com", level: 730)
user36 = User.create(username: "MysticDruid", first_name: "Avery", last_name: "Fisher", email: "avery.fisher@druidcircle.net", level: 620)
user37 = User.create(username: "QuantumRogue", first_name: "Matthew", last_name: "Sullivan", email: "matthew.sullivan@quantumrealm.org", level: 800)
user38 = User.create(username: "WitchDoctor", first_name: "Scarlett", last_name: "Bennett", email: "scarlett.bennett@voodoomagic.com", level: 790)
user39 = User.create(username: "DragonKnight", first_name: "Nathan", last_name: "Simmons", email: "nathan.simmons@dragonorder.com", level: 870)
user40 = User.create(username: "CelestialWizard", first_name: "Aubrey", last_name: "Rogers", email: "aubrey.rogers@celestialorder.net", level: 920)

#events
puts("creating some awesomes events...")

# Événements
event1 = Event.create(user_id: user1, name: "The Dark Forest Mystery",
                      ...
                      category: "Adventure", theme: "Fantasy", address: "Edwinstowe, Mansfield NG21 9QB, Royaume-Uni", price: 35, participants_min: 15, participants_max: 50, date_sub: '2024-09-10', date_event: '2024-09-15', status: "Open")
event3 = Event.create(user_id: user3.id, name: "Medieval Siege of Castle Black",
...
event2 = Event.create(user_id: user2, name: "Cyberpunk City Escape",
...
event4 = Event.create(user_id: user4, name: "Steampunk Airship Voyage",
...
event5 = Event.create(user_id: user5, name: "Zombie Apocalypse Survival",
...
event6 = Event.create(user_id: user6, name: "Vampire Masquerade Ball",
...
event7 = Event.create(user_id: user7, name: "Pirate Treasure Hunt",
...
event8 = Event.create(user_id: user8, name: "Space Station Escape",
...
event9 = Event.create(user_id: user9, name: "Ancient Mythology Quest",
...
event10 = Event.create(user_id: user10, name: "Western Showdown",
...
# Événements ouverts
event16 = Event.create(user_id: user6, name: "Cyberpunk Heist",
...
event17 = Event.create(user_id: user7, name: "Arthurian Legends Battle",
...
event18 = Event.create(user_id: user8, name: "Steampunk Invention Fair",
...
event19 = Event.create(user_id: user9, name: "Medieval Jousting Tournament",
...
event20 = Event.create(user_id: user10, name: "Pirate Ship Battle",
...
# Événements passés
event11 = Event.create(user_id: user1, name: "Medieval Festival",
...
event12 = Event.create(user_id: user2, name: "Zombie Invasion",
...
event13 = Event.create(user_id: user3, name: "Steampunk Mystery Dinner",
...
event14 = Event.create(user_id: user4, name: "Fantasy Quest Adventure",
...
event15 = Event.create(user_id: user5, name: "Victorian Era Ball",
...
event21 = Event.create(user_id: user1, name: "Victorian Era Mystery",
...
event22 = Event.create(user_id: user2, name: "Zombie Apocalypse Training",
...
event23 = Event.create(user_id: user3, name: "Fantasy Realm Quest",
...
event24 = Event.create(user_id: user4, name: "Space Odyssey Challenge",
...
event25 = Event.create(user_id: user5, name: "Post-Apocalyptic Survival Camp",
